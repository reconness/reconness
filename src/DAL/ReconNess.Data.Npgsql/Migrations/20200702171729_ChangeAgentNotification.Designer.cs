...
namespace ReconNess.Data.Npgsql.Migrations
{
    ...
    [Migration("20200702171729_ChangeAgentNotification")]
    partial class ChangeAgentNotification
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ReconNess.Entities.AgentNotification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<Guid>("AgentRef")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ReconNess.Entities.AgentNotification", b =>
                {
                    b.HasOne("ReconNess.Entities.Agent", "Agent")
                        .WithOne("AgentNotification")
                        .HasForeignKey("ReconNess.Entities.AgentNotification", "AgentRef")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
