...
namespace ReconNess.Infrastructure.DataAccess.Migrations
{
    ...
    [Migration("20191125041848_AllowSubdomainColumnsNull")]
    partial class AllowSubdomainColumnsNull
    {
            ...
            modelBuilder.Entity("ReconNess.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("4c1d4845-bfbb-447a-b60f-6394ca914c53"),
                        ...
                        new
                        {
                            Id = new Guid("77571c6e-1483-4bda-b2fb-feb2816aa71a"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Deleted = false,
                        ...
                        new
                        {
                            Id = new Guid("33e53bee-839e-4ba6-b8d2-1de354814bea"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Deleted = false,
            ...
            modelBuilder.Entity("ReconNess.Entities.Label", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e89e6919-7fbb-4299-968c-a817c01bbeac"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Deleted = false,
                            Name = "Ignore",
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        ...
                        new
                        {
                            Id = new Guid("360b8cbc-2de9-423c-9bac-fe478ca30d2e"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Deleted = false,
                            Name = "ToCheck",
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        ...
                        new
                        {
                            Id = new Guid("2a05964a-dfc9-42e6-b5f1-564972cbb195"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Deleted = false,
                            Name = "Checking",
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        ...
                        new
                        {
                            Id = new Guid("a41f44a6-52f1-480e-bc73-9cbb35625581"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Deleted = false,
                            Name = "Bounty",
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
