...
namespace ReconNess.Data.Npgsql.Migrations
{
    ...
    [Migration("20191129040330_AddAgentOnlyIfIsAliveColumn")]
    partial class AddAgentOnlyIfIsAliveColumn
    {
            ...
            modelBuilder.Entity("ReconNess.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("c346ffdb-db7d-4c55-920f-86c2f890397d"),
                        ...
                        new
                        {
                            Id = new Guid("c3d962e5-eeb4-44be-bca9-0076ca9c0613"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Deleted = false,
                        ...
                        new
                        {
                            Id = new Guid("a4fd9387-d51e-4e0d-8053-a5c6a3778a9a"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Deleted = false,
            ...
            modelBuilder.Entity("ReconNess.Entities.Label", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("92cd1726-d987-406e-899d-e63d7778374c"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Deleted = false,
                            Name = "Ignore",
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        ...
                        new
                        {
                            Id = new Guid("71869056-34c9-4a56-9935-b01c1808feb9"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Deleted = false,
                            Name = "ToCheck",
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        ...
                        new
                        {
                            Id = new Guid("df80e098-83c7-4c44-87fd-aad75dc7e35a"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Deleted = false,
                            Name = "Checking",
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        ...
                        new
                        {
                            Id = new Guid("6420c610-cde3-48fb-a0d8-3d9d56896c0a"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Deleted = false,
                            Name = "Bounty",
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
